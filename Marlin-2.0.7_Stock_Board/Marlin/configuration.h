...
#define STRING_CONFIG_H_AUTHOR "Kristaps Dravnieks" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 438.60             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.31, 0.00, -1.08 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 227.54              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.14, -0.10, -0.04 } // Get these values from G33 auto calibrate
...
#define INVERT_E0_DIR false //for BMG extruder, to use stock extruder set to true
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_NOZZLE_SIZE    0.40 // (mm) Diameter of primary nozzle.
...
#define TOUCH_SCREEN
  ...
  #define XPT2046_X_OFFSET       -16  //was -43
  #define XPT2046_Y_OFFSET        67  //was 257
#endif
